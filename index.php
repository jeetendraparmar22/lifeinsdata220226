<?php
include_once('core/authClass.php');
?>
<!DOCTYPE html>
<html lang="en">
							...
							<form class="pt-3" method='post' action='index.php'>
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control form-control-lg border-left-0" placeholder="Username" name="username" autofocus>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="exampleInputPassword">Select User</label>
									<select class="form-control form-control-lg" id="exampleFormControlSelect1" name="utype">
